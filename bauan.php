...
$sql = "SELECT * FROM destinations WHERE town = 'Bauan'";
$bauanResult = $conn->query($sql);
...
<body>  
    ...
    <div class="destinations-img">
        <img src="icons/search-bauan.png">
    </div>
    ...
    <div class="destination-wrapper">
        ...
        if ($bauanResult->num_rows > 0) {
            // Loop through each destination
            while ($row = $bauanResult->fetch_assoc()) {
                $id = $row['id'];
