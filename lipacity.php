...
$sql = "SELECT * FROM destinations WHERE town = 'Lipa City'";
$lipacityResult = $conn->query($sql);
...
<body>  
    <nav class="navbar">
        <div class="max-width">
            ...
            <div class="itinerary">
                ...
                <div class="itinerary-btn-box"><img class="loc-ico" src="icons/itineraries-location-icon.png"><a href="itineraries.php" id="itinerary-count"><?php echo $number_of_destinations; ?></a></div>
            </div>
        </div>
    </nav>
    ...
    <div class="destinations-img">
        <img src="icons/search-lipacity.png">
    </div>
    ...
    <div class="destination-wrapper">
        ...
        if ($lipacityResult->num_rows > 0) {
            // Loop through each destination
            while ($row = $lipacityResult->fetch_assoc()) {
                $id = $row['id'];
