...
$sql = "SELECT * FROM destinations WHERE town = 'Taal'";
$taalResult = $conn->query($sql);
...
<body>  
    ...
    <div class="destination-wrapper">
        ...
        if ($taalResult->num_rows > 0) {
            // Loop through each destination
            while ($row = $taalResult->fetch_assoc()) {
                $id = $row['id'];
